 ...
 * @module @omdsh-plugins/omdsh-chatmode/tests/registry-mode-guard
 */

throw new Error(
  'omdsh-chatmode: the browser specs need a harness checkout, but this package is pinned to the '
