 ...
 * @module @omdsh-plugins/omdsh-justchat/tests/registry-mode-guard
 */

throw new Error(
  'omdsh-justchat: the browser specs need a harness checkout, but this package is pinned to the '
